...
t_lcdState lcdCommandSecondLine[]=
{
...
void lcdNibbleSend(char mode,char lowerNibble)
   {
   lcdRs=mode;
   lcdDat7=BIT_GETVAL(lowerNibble,3);
   lcdDat6=BIT_GETVAL(lowerNibble,2);
   lcdDat5=BIT_GETVAL(lowerNibble,1);
   lcdDat4=BIT_GETVAL(lowerNibble,0);
   xportDriver();
   lcdEn=1;
   xportDriver();
   lcdEn=0;
