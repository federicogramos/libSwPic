 ...
 * se vayan procesando sus conversiones. Cada vez que corre la función, inicia u
 * na conversión. No inicia si:
 * -- hay conversion pendiente para leer en el buffer.
 * -- está haciendo una conversión que aún no finalizó.
 *
 * Ubicar esta función fuera de las interrupciones, idealmente en un loop periód
 * ico de programa.
 ******************************************************************************/
...
void adc16f_driver(void) {           
    ...
    if(adc16f_t.flgs2convert && !adc16f_t.inProcessFlg) {
        do {
            // Busca un flag seteado para iniciar conversión
...
/*******************************************************************************
 * @brief
 * @return Conversión en 8 bits (seteo alineación izquierda en adcSetup()
 ******************************************************************************/
